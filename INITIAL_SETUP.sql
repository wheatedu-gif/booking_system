...
CREATE POLICY "Public Update Apt" ON appointments FOR UPDATE USING (true); -- 允許客戶取消自己的預約
...
INSERT INTO page_content (section_key, content) VALUES ('landing_page', '{"brand_name": "智慧預約", "hero": {"title": "專業預約管理", "subtitle": "立即預約您的專屬服務", "cta_booking": "立即預約", "cta_login": "登入"}, "features": []}');

-- =========================================================
-- 智慧預約系統 - 終極整合初始化腳本 (V10 營運強化版)
-- =========================================================

-- 0. 環境與擴充功能
CREATE EXTENSION IF NOT EXISTS pgcrypto;

-- 1. 清理舊結構 (開發階段建議，正式營運請謹慎使用)
...
CREATE TABLE appointments (
  ...
  admin_notes TEXT, -- [新增] 管理員專用筆記
  source TEXT DEFAULT 'online', -- [新增] 預約來源 (online/manual)
...
('email_templates', '{"new_booking": {"subject": "收到預約申請", "body": "您好 {name}，預約待處理中。"}, "confirmed": {"subject": "預約確認", "body": "您好 {name}，預約已確認！"}, "cancelled": {"subject": "預約取消", "body": "您好 {name}，預約已取消。"}}'::jsonb);

INSERT INTO page_content (section_key, content) VALUES ('landing_page', '{"brand_name": "智慧預約", "hero": {"title": "極簡高效預約系統", "subtitle": "立即體驗", "cta_booking": "立即預約", "cta_login": "登入"}, "features": []}');

-- =========================================================
-- 智慧預約系統 - 最終全功能整合初始化腳本 (V2 完整版)
-- 包含：雙軌驗證、動態表單、時段管理、CMS(含圖示/Logo)、取消原因
-- =========================================================
...
-- 管理員全面管理 (只要是登入者先允許讀取，細節由前端 role 判斷，後端依賴 Auth 狀態)
...
-- 預設 CMS 內容 (包含 icon 與 brand_name)
